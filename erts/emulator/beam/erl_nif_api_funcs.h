...
ERL_NIF_API_FUNC_DECL(void,enif_ioq_lock,(ErlNifIOQueue *q));
ERL_NIF_API_FUNC_DECL(void,enif_ioq_unlock,(ErlNifIOQueue *q));
ERL_NIF_API_FUNC_DECL(int,enif_ioq_open,(ErlNifEnv *env, ERL_NIF_TERM term, ErlNifIOQueue **q));
